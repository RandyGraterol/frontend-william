    ...
    extend: {
      colors: {
        ...
        institutional: {
          ...
          "blue-light": "hsl(var(--institutional-blue-light))",
          green: "hsl(var(--institutional-green))",
          amber: "hsl(var(--institutional-amber))",
          gray: "hsl(var(--institutional-gray))",
        },
        metric: {
          blue: "hsl(var(--metric-blue))",
          "blue-bg": "hsl(var(--metric-blue-bg))",
          green: "hsl(var(--metric-green))",
          "green-bg": "hsl(var(--metric-green-bg))",
          amber: "hsl(var(--metric-amber))",
          "amber-bg": "hsl(var(--metric-amber-bg))",
        },
        status: {
